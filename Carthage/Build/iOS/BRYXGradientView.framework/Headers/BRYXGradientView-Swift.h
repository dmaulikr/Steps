...
@property (nonatomic, strong) UIColor * __nonnull topColor;
@property (nonatomic, strong) UIColor * __nonnull bottomColor;
...
@property (nonatomic, readonly, strong) CAGradientLayer * __nonnull gradientLayer;
